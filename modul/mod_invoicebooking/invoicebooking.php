              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  if (empty(isset($_GET['kata']))) {
                    ...
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND guest_username='$_SESSION[guest_username]' LIMIT $posisi,$batas");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND guest_username='$_SESSION[guest_username]'"));
                    ...
                    <td><?php echo tgl_indo($invoice['invoice_created']) ?>
                      ...
                      <td align="center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">       <?php if (!$invoice['invoice_photo']) { ?>
                            <li>
                              <a href="?module=invoicebooking&act=upload&id=<?php echo $invoice['invoice_id'] ?>" title="Upload <?php echo $invoice['invoice_id'] ?>"><i class='fa fa-money'></i> Upload Bukti Pembayaran</a>
                            </li>
                  <?php } ?>
                            <li>
                              <a href="?module=invoicebooking&act=detail&id=<?php echo $invoice['invoice_id'] ?>" title="Detail <?php echo $invoice['invoice_id'] ?>"><i class='fa fa-eye'></i> Detail</a>
                            </li>
                          </ul>
                        </div>
  ...
  <div class="cl-mcont">
    <div class="row">
      <div class="col-md-12">
        <div class="block-flat">
          <div class="content">
            <form role="form" class="form-horizontal" action="<?php echo $aksi ?>?module=invoicebooking&act=upload" method="post" enctype="multipart/form-data" parsley-validate novalidate>
              <input name="invoice_id" hidden type="text" value='<?php echo $invoice['invoice_id'] ?>'/>
              ...
              <div class="table-responsive">
                <table class="table no-border hover">
                  ...
                  <td>
                    <input name="invoice_id" type="text" required readonly class="form-control input-sm" id="invoice_id" placeholder="Masukan No Booking" value="<?php echo $invoice['invoice_id'] ?>"/>
                  </td>
                </tr> 
                
                <tr>
                      <td width=200>
                        <label for="fupload" class="control-label">Bukti Pembayaran <span class="required">*</span></label>
                      </td>
                      <td>
                        <input name="fupload" type="file" required class="form-control" id="fupload"/>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class='center'>
            <input class="btn btn-primary" type="submit" name="simpan" value="Upload">
          ...
          <div class="content">
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND guest_username='$_SESSION[guest_username]' AND invoice_id='$_GET[id]'");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='booking' AND guest_username='$_SESSION[guest_username]' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
