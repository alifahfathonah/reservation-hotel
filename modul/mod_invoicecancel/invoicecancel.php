              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  if (empty(isset($_GET['kata']))) {
                    ...
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND guest_username='$_SESSION[guest_username]' LIMIT $posisi,$batas");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND guest_username='$_SESSION[guest_username]'"));
                    ...
                    <td class="center" rowspan="2"><?php echo $invoice['invoice_id'] ?></td>
                                                <td> 
                                                <?php echo $invoice['invoice_cancel'] ?>
                                                </td>
                                                <td>
                                                <?php
                    ...
                    <td>
                    Rp<?php echo format_rupiah($invoice['invoice_price']) ?>,00
                    </td>
                      ...
                      <td align="center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                              <a href="?module=invoicecancel&act=detail&id=<?php echo $invoice['invoice_id'] ?>" title="Detail <?php echo $invoice['invoice_id'] ?>"><i class='fa fa-eye'></i> Detail</a>
                            </li>
                          </ul>
                        </div>
          ...
          <div class="content">
              ...
              <div class="table-responsive">
                <table class="hover">
                  ...
                  <tbody>
                  <?php
                    $result=mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND guest_username='$_SESSION[guest_username]' AND invoice_id='$_GET[id]'");
                    $jmldata = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM invoice WHERE invoice_status='cancel' AND guest_username='$_SESSION[guest_username]' AND invoice_id='$_GET[id]'"));
                    if(mysqli_num_rows($result) === 0) {
                    ?>
                    <tr>
                      <td class="center" colspan="10">Data kosong...</td>
